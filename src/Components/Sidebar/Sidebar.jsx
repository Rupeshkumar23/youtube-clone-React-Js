    ...
    <div className={`sidebar ${sidebar?"":"small_sidebar"}`}>
        ...
        <div className="subscribed_list">
            ...
            <div className="side_link">
                <img src={jack} alt="profileImg" /><p>PewDiePie</p>
            </div>
            <div className="side_link">
                <img src={simon} alt="profileImg" /><p>MrBeast</p>
            </div>
            <div className="side_link">
                <img src={tom} alt="profileImg" /><p>Justin Bieber</p>
            </div>
            <div className="side_link">
                <img src={megan} alt="profileImg" /><p>5-Minute Crafts</p>
            </div>
            <div className="side_link">
                <img src={cameron} alt="profileImg" /><p>Nas Daily</p>
            </div>
        </div>
